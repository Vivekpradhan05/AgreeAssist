...
const InputField = ({type, placeholder, name, handleChange, address })=>(
    ...
    text-gray-500 focus:border-sky transistion'
     type={type}
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping 
            <span className='font-semibold text-sky-500'> Address</span>
        </p>
                   ...
                   <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                       ...
                       <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                         ...
                         <button className='w-full mt-6 bg-sky-500 text-white py-3 hover:bg-sky-700 transition cursor-pointer uppercase'>
                             Save address
                         </button>
