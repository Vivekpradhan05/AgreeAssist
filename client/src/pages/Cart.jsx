...
const Cart = () => {
    const {products, currency, cartItems, removeFromCart, getCartCount,
       ...
       // This is for set user address in right side on top of place order button
...
// tHIS IS FOR PLACE ORDER 
    ...
    return products.length > 0 && cartItems ?  (
         ...
         // Set color indigo instead of Primary where indigo-500 to set primary and bg-primary-dull
